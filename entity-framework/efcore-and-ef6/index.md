...
EF Core works with SQL Server/SQL Azure, SQLite, Azure Cosmos DB, [MySQL](https://www.mysql.com/), PostgreSQL, and many more databases through a [database provider plugin model](xref:core/providers/index).
