...
EF Core works with SQL Server/SQL Azure, SQLite, Azure Cosmos DB, MySQL, [PostgreSQL](https://www.postgresql.org/), and many more databases through a [database provider plugin model](xref:core/providers/index).
