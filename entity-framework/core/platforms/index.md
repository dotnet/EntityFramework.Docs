...
<sup>(1)</sup> This version of .NET UWP adds support for .NET Standard 2.0. Testing has revealed [a few issues](https://github.com/aspnet/EntityFrameworkCore/issues?q=is%3Aopen+is%3Aissue+milestone%3A2.0.1+label%3Aarea-uwp) which will require a patch of EF Core 2.0.
