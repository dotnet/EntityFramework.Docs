...
* Configuration options data seeding (`UseSeeding`)
* Custom initialization logic
* Model managed data (`HasData`)
...
* Previously managed data will be removed if the primary key is changed in any way.
