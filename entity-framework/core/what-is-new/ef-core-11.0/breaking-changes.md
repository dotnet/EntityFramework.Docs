...
This change applies only to the `Microsoft.Data.Sqlite` package. The EF Core SQLite provider (`Microsoft.EntityFrameworkCore.Sqlite`) now references `SQLitePCLRaw.bundle_e_sqlite3`.
