...
------------------------
 ...
 - To add EF to your project, modify ``project.json`` so it matches the following sample.
    ...
    .. literalinclude:: /samples/NetCore/EFGetStarted.ConsoleApp.SQLite/project.json
            :language: json
            :linenos:
...
The next steps will add code to configure and access a SQLite database file.
 ...
 - Create a new file called ``Model.cs``
    All classes in the following steps will be added to this file.
        ...
        .. literalinclude:: /samples/NetCore/EFGetStarted.ConsoleApp.SQLite/Model.cs
            :language: c#
            :linenos:
            :lines: 1-6
...
.. literalinclude:: /samples/NetCore/EFGetStarted.ConsoleApp.SQLite/Program.cs
    :language: c#
    :linenos:
