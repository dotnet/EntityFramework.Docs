...
.. note:: Prior to installation: Either, ensure Package source is set to nuget.org:

.. note::	`Tools --> NuGet Package Manager --> Package Manager Settings --> Package Sources`

.. note::	Check the box for nuget.org

.. note::	`Package Manager Console --> Package source: --> nuget.org`

.. note::Or, Append to the end of the command ``-Source nuget.org``

.. note::Run ``Install-Package EntityFramework.SqlServer –Pre``
