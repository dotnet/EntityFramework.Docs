Relational Databases: Data Types
================================
...
By convention, the database provider selects a data type based on the CLR type of the property. It also takes into account other metadata, such as the configured :doc:`max-length`, whether the property is part of a primary key, etc.
...
.. literalinclude:: configuring/sample/EFModeling.Configuring.DataAnnotations/Samples/Relational/DataType.cs
        :language: c#
        :lines: 11-16
        :emphasize-lines: 4
        :linenos:
