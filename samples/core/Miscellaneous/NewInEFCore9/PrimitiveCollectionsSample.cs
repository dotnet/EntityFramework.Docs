...
{
    public static Task Queries_using_readonly_primitive_collections()
    {
        PrintSampleName();
        return ContainsTest<PubsAndWalksContext>();
    }

    public static Task Queries_using_readonly_primitive_collections_SQLite()
    {
        PrintSampleName();
    ...
    public class PrimitiveCollections
    {
        ...
        public IReadOnlyList<int> Ints { get; set; } = null!;
        public IReadOnlyCollection<string> Strings { get; set; } = null!;
        public ReadOnlyCollection<DateTime> DateTimes { get; set; } = null!;
    ...
    public class Pub
    {
        public Pub(string name, IReadOnlyCollection<string> beers)
        {
            Name = name;
            Beers = beers;
        }
    ...
    public abstract class PubsAndWalksContextBase : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder
                ...
                .PrimitiveCollection(e => e.Booleans)
                .HasMaxLength(1024)
                .IsUnicode(false);

            modelBuilder
                .Entity<PrimitiveCollections>()
                .PrimitiveCollection(e => e.Guids)
                .HasColumnType("nvarchar(2000)");

            modelBuilder
                .Entity<PrimitiveCollections>()
                .PrimitiveCollection(e => e.GetOnlyInts);

            modelBuilder
                .Entity<PrimitiveCollections>()
                .PrimitiveCollection(e => e.DddIds)
                .ElementType(b => b.HasConversion<DddIdConverter>());
            ...
            modelBuilder.Entity<Pub>().PrimitiveCollection(e => e.DaysVisited);
        }
        ...
        public async Task Seed()
        {
            Add(
                new PrimitiveCollections
                {
                    ...
                    DateTimes =
                        new ReadOnlyCollection<DateTime>([new(2023, 1, 1, 1, 1, 1), new(2023, 2, 2, 2, 2, 2), new(2023, 3, 3, 3, 3, 3)]),
            ...
            ((List<DateOnly>)oak.DaysVisited).AddRange(
            [
                new(2021, 1, 2),
                new(2021, 8, 7),
                new(2023, 3, 22),
            ...
            ((List<DateOnly>)feathers.DaysVisited).AddRange(
            [
                new(2022, 11, 17),
                new(2021, 9, 25),
                new(2022, 12, 21),
            ...
            ((List<DateOnly>)swan.DaysVisited).AddRange(
            [
                new(2021, 2, 24),
                new(2022, 8, 3),
                new(2022, 9, 14),
            ...
            ((List<DateOnly>)fbi.DaysVisited).AddRange(
            [
                new(2022, 11, 30),
                new(2022, 2, 15),
                new(2021, 12, 9),
            ...
            ((List<DateOnly>)eltisley.DaysVisited).AddRange(
            [
                new(2022, 6, 19),
                new(2021, 1, 15),
                new(2022, 3, 24),
            ...
            await AddRangeAsync(
                new DogWalk("Ailsworth to Nene")
                {
                    ...
                    DaysVisited = new ReadOnlyCollection<DateOnly>(
                    [
                        new(2022, 11, 17),
                        new(2021, 9, 25),
                        new(2022, 12, 21),
