...
public static class ImmutableComplexTypesSample
{
    public static Task Use_immutable_class_as_complex_type()
    {
        PrintSampleName();
        return ComplexTypeTest<CustomerContext>();
    }

    public static Task Use_immutable_class_as_complex_type_SQLite()
    {
        PrintSampleName();
        ...
        where TContext : CustomerContextBase, new()
    {
        ...
        var customer = new Customer() { Name = "Willow", Address = new("Barking Gate", null, "Walpole St Peter", "UK", "PE14 7AV") };
