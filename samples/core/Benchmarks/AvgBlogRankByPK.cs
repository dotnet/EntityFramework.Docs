...
namespace Benchmarks
{
    ...
    public class AvgBlogRankByPK
    {
        ...
        // would normally come from appsettings.json, but for simplicity is hardwired here
        private const string _sqlConnString = "Server=(localdb)\\mssqllocaldb;Database=Blogging;Integrated Security=True";
